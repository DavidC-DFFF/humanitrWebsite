...
{/*------------------------------------------------------------------*/}
  ...
  {/*------------------------------------------------------------------*/}
      <div className='box'>                     {/*---- Whitelisting --*/}
        <div className='box-header'>Whitelisting</div>
        <div>
          <input className='faucet-management-input' style={{width: '17em'}} placeholder='enter token address' onChange={e => setTempToken(e.target.value)}/>
        </div>
        <div>
          <button className='faucet-default-button' onClick={addToWhiteList}>Send</button>
          <button className='faucet-default-button' onClick={removeFromWhiteList}>Remove</button>
        </div>
      </div>
    </div>)
}