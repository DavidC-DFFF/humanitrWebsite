...
export function SwapSushiswap () {

    const [ swapSwitch, setSwapSwitch ] = useState();
    
    return(<div>
        {!swapSwitch && (
        <div className='box' onClick={() => setSwapSwitch(!swapSwitch)}>
            <div className="box-header-arrow">
                <div>Swap</div>
                <img src={downArrow} style={{height: '4vh'}} alt="down Arrow"/>
            </div>
        </div>)}
        {swapSwitch && (<div className='box' onClick={() => setSwapSwitch(!swapSwitch)}>
            <div className="box-header-arrow">
                <div>Swap</div>
